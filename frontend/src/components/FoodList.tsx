import { ArrowUpDown, Leaf, Search } from "lucide-react";
...
export function FoodList({
  ...
  return (
    <div className="grid gap-6">
      <section className="grid gap-4 rounded-3xl border border-[#E8E4DE] bg-white/80 p-6 shadow-sm md:grid-cols-3">
