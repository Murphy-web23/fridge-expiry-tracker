...
export function FoodCard({ food, onMarkUsed, onAdjustQuantity }: FoodCardProps) {
  ...
  return (
    <article
      className={`flex min-h-[330px] flex-col rounded-3xl border border-l-4 border-[#E8E4DE] bg-white/80 p-6 shadow-[0_4px_20px_rgba(61,56,52,0.05)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${status.accent}`}
    >
      ...
      <div className="mt-auto flex items-center gap-2 pt-5">
        <button
          ...
          className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#E8E4DE]/60 text-[#3D3834] transition-colors hover:bg-[#E8E4DE] disabled:opacity-40"
        >
        ...
        <button
          ...
          className="inline-flex min-h-11 min-w-0 flex-1 items-center justify-center gap-2 rounded-2xl bg-[#8BA888]/15 px-4 py-2.5 font-medium text-[#5D775A] transition-colors hover:bg-[#8BA888]/25 disabled:opacity-50"
        >
