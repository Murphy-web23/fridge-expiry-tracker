...
冰箱裡的食材常常因為忘記保存期限而浪費。這個專案希望用簡單的資料記錄、期限計算與 Dashboard，幫助使用者快速掌握哪些食材需要優先處理。
...
- Dashboard 顯示總食材數、7 天內到期數、今天到期數、已過期數
- 顯示最急需處理的食材清單
- 支援期限狀態篩選、分類篩選與排序
- 支援標記已使用與刪除食材
- 繁體中文介面，適合作為初學者作品集專案
...
- 使用 `days_left` 衍生欄位串起 Dashboard 統計、狀態標籤、篩選與排序。
